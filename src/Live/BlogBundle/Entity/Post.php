...
use Znieh\UserBundle\Entity\User as User;
...
class Post
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Znieh\UserBundle\Entity\User", cascade={"persist"})
     */
    private $author;
     ...
     * Set author
     *
     * @param \Znieh\UserBundle\Entity\User $author
     * @return Post
     */
    public function setAuthor(\Znieh\UserBundle\Entity\User $author)
    {
        $this->author = $author;
