...
function setMyUnitsSide() {
  ...
  for (var i = units.length - 1; i >= 0; i--) {
    ...
    $("#myUnits").prepend(getUnitsMenuRender(0, i, units[i], ContentManager.left));
...
function setEnnemySide() {
    ...
    if(ennemySideSauv == null)
    {
      ...
      for (var i = ennemyUnits.length - 1; i >= 0; i--) {
        $("#ennemyUnits").prepend(getUnitsMenuRender(1, i, ennemyUnits[i], ContentManager.left));
      }
    }
    else if(flag == 1)
    {
...
function getUnitsMenuRender(type, i, data, left) { // Type : 0 (myUnits) | 1 (ennemyUnits)
  var render;

  if((left == true && type == 1) || (left == false && type == 0)) {
    render = '<div class="row unit" id="unit-' + i + '" data-unit="' + i + '" data-unit-game="">';
      render +='  <div class="col-sm-12">';
        render +='  <div class="row">';
          render +='  <div class="col-sm-3">';
            render +='  <div class="portrait">';
              render +='  <img id="unit-' + i + '-img" />';
            render +='  </div>';
          render +='  </div>';
          render +='  <div class="col-sm-5 stats">';
            render +='  <img src="../img/icons/attack.png" alt="Attaque"> 67 <img src="../img/icons/defense.png" alt="Défense"> 35 <img src="../img/icons/precision.png" alt="Précision"> 54';
          render +='  </div>';
          render +='  <div class="col-sm-4">';
            render +='  <div class="progress life">';
              render +='  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ' + data.life + '%"></div>';
            render +='  </div>';
          render +='  </div>';
        render +='  </div>';
        render +='  <div class="row">';
          render +='  <div class="col-sm-3">';
            render +='  <div class="name">' + data.name + '</div>';
          render +='  </div>';
          render +='  <div class="col-sm-offset-1 col-sm-8">';
            render +='  <div class="skills">';
              render +='  <img src="../img/icons/spell0.png" alt="Attaque"><img src="../img/icons/spell1.png" alt="Attaque"><img src="../img/icons/spell2.png" alt="Attaque"><img src="../img/icons/spell3.png" alt="Attaque">';
            render +='  </div>';
          render +='  </div>';
        render +='  </div>';
      render +='  </div>';
